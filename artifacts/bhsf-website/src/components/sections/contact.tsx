      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-lg overflow-hidden flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 bg-primary p-10 text-primary-foreground">
            <h2 className="text-3xl font-bold font-serif mb-6 text-white">{t("Get in Touch")}</h2>
            <p className="text-primary-foreground/80 mb-10">
              {t("Have questions about our programs, or want to volunteer? We'd love to hear from you.")}
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white mb-1">{t("Office")}</h4>
                  <p className="text-primary-foreground/80">{t("Sanchez Mira")}<br />{t("Cagayan, Philippines")}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white mb-1">{t("Phone")}</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white mb-1">{t("Email")}</h4>
            ...
            <div className="mt-12 pt-8 border-t border-white/20">
              <p className="text-sm text-primary-foreground/60 mb-1">{t("Direct contact:")}</p>
              <p className="font-bold text-white">Dr. Connie Marie Oroceo-Sacramed</p>
              <p className="text-sm text-primary-foreground/80">{t("Vice Mayor & Fund Coordinator")}</p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-10 flex items-center justify-center bg-white relative overflow-hidden">
            ...
            <div className="text-center relative z-10 max-w-sm">
              <h3 className="text-2xl font-bold font-serif text-primary mb-4">{t("Partner With Us")}</h3>
              <p className="text-muted-foreground mb-8">
                {t("Are you a medical professional, local business, or organization looking to partner with BHSF? Reach out to discuss collaboration opportunities.")}
              </p>
              <a 
